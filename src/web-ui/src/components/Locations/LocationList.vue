<template>
  <div class="container">
    ...
    <div v-else v-for="location in locations" :key="location.Id">
      <LocationDetail :location="location" :changeViewport="locationMapContext.changeViewport" :showDirections="locationMapContext.showDirections" :setSelectedLocation="locationMapContext.setSelectedLocation" class="mb-2" />
    </div>
  </div>
</template>
